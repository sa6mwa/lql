...
func printUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  /timestamp>=\"2025-01-01T00:00:00Z\"")
	...
	fmt.Fprintln(w, "  date{field=/timestamp,after=2025-01-01,before=2025-02-01}")
	fmt.Fprintln(w, "  date{f=/timestamp,since=yesterday}")
	...
	fmt.Fprintln(w, "Note: range comparisons accept numeric or datetime literals (YYYY-MM-DD, RFC3339Nano, RFC3339, or naive UTC YYYY-MM-DDTHH:MM:SS[.fffffffff]).")
